...
export function VerifyIdentityBanner({ status }: { status: IdentityStatus }) {
  ...
  return (
    <div className="sticky top-0 z-30 border-b border-white/20 bg-[rgba(8,8,16,0.92)] backdrop-blur-xl">
      <div className="mx-auto flex max-w-3xl flex-col gap-3 px-4 py-3.5 sm:flex-row sm:items-center sm:justify-between md:px-6">
        <div className="flex items-start gap-3">
          <div className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-white/20 bg-white/[0.07]">
